...
module.exports=function e(t){Object.freeze(t);var o="function"==typeof t,n=Object.prototype.hasOwnProperty;return Object.getOwnPropertyNames(t).forEach(function(r){!n.call(t,r)||o&&("caller"===r||"callee"===r||"arguments"===r)||null===t[r]||"object"!=typeof t[r]&&"function"!=typeof t[r]||Object.isFrozen(t[r])||e(t[r])}),t};
...
(function (global){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}exports.__esModule=!0;var _extends=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var i=arguments[e];for(var s in i)Object.prototype.hasOwnProperty.call(i,s)&&(t[s]=i[s])}return t},_Utils=require("../core/Utils"),_Utils2=_interopRequireDefault(_Utils),_Translator=require("../core/Translator"),_Translator2=_interopRequireDefault(_Translator),_namespaceEmitter=require("namespace-emitter"),_namespaceEmitter2=_interopRequireDefault(_namespaceEmitter),_deepFreezeStrict=require("deep-freeze-strict"),_deepFreezeStrict2=_interopRequireDefault(_deepFreezeStrict),_UppySocket=require("./UppySocket"),_UppySocket2=_interopRequireDefault(_UppySocket),_en_US=require("../locales/en_US"),_en_US2=_interopRequireDefault(_en_US),Core=function(){function t(e){_classCallCheck(this,t);var i={locales:_en_US2.default,autoProceed:!0,debug:!1};this.opts=_extends({},i,e),this.types=["presetter","orchestrator","progressindicator","acquirer","modifier","uploader","presenter","debugger"],this.type="core",this.plugins={},this.translator=new _Translator2.default({locales:this.opts.locales}),this.i18n=this.translator.translate.bind(this.translator),this.getState=this.getState.bind(this),this.updateMeta=this.updateMeta.bind(this),this.initSocket=this.initSocket.bind(this),this.log=this.log.bind(this),this.emitter=(0,_namespaceEmitter2.default)(),this.state={files:{}},this.opts.debug&&(global.UppyState=this.state,global.uppyLog="",global.UppyAddFile=this.addFile.bind(this))}return t.prototype.updateAll=function(t){var e=this;Object.keys(this.plugins).forEach(function(i){e.plugins[i].forEach(function(e){e.update(t)})})},t.prototype.setState=function(t){var e=_extends({},this.state,t);this.emitter.emit("state-update",this.state,e,t),this.state=e,this.updateAll(this.state),this.log("Updating state with: "),this.log(e)},t.prototype.getState=function(){return(0,_deepFreezeStrict2.default)(this.state)},t.prototype.updateMeta=function(t,e){var i=_extends({},this.getState().files),s=_extends({},i[e].meta,t);i[e]=_extends({},i[e],{meta:s}),this.setState({files:i})},t.prototype.addFile=function(t){var e=_extends({},this.state.files),i=t.name||"noname",s=_Utils2.default.getFileType(t)?_Utils2.default.getFileType(t).split("/"):["",""],r=s[0],a=s[1],o=_Utils2.default.getFileNameAndExtension(i)[1],n=t.isRemote||!1,l=_Utils2.default.generateFileID(i),u={source:t.source||"",id:l,name:i,extension:o||"",meta:{name:i},type:{general:r,specific:a},data:t.data,progress:{percentage:0,uploadComplete:!1,uploadStarted:!1},size:t.data.size,isRemote:n,remote:t.remote||""};e[l]=u,this.setState({files:e}),this.emitter.emit("file-added",l),"image"!==r||n||this.addFileThumbnail(u.id),this.opts.autoProceed&&this.emitter.emit("core:upload")},t.prototype.addFileThumbnail=function(t,e){var i=this,s=this.getState().files[t];_Utils2.default.readFile(s.data).then(_Utils2.default.createImageThumbnail).then(function(e){var s=_extends({},i.getState().files),r=_extends({},s[t],{preview:e});s[t]=r,i.setState({files:s})})},t.prototype.actions=function(){var t=this;this.emitter.on("file-add",function(e){t.addFile(e)}),this.emitter.on("file-remove",function(e){var i=_extends({},t.getState().files);delete i[e],t.setState({files:i})}),this.emitter.on("core:file-upload-started",function(e,i){var s=_extends({},t.getState().files),r=_extends({},s[e],_extends({},{progress:_extends({},s[e].progress,{uploadStarted:Date.now()})}));s[e]=r,t.setState({files:s})}),this.emitter.on("upload-progress",function(e){var i=e.id,s=_extends({},t.getState().files);if(!s[i])return void console.error("Trying to set progress for a file that’s not with us anymore: ",i);var r=_extends({},s[i],_extends({},{progress:_extends({},s[i].progress,{bytesUploaded:e.bytesUploaded,bytesTotal:e.bytesTotal,percentage:Math.round((e.bytesUploaded/e.bytesTotal*100).toFixed(2))})}));s[e.id]=r;var a=Object.keys(s).filter(function(t){return!s[t].progress.uploadComplete&&s[t].progress.uploadStarted}),o=100*Object.keys(a).length,n=0;a.forEach(function(t){n+=s[t].progress.percentage});var l=100*n/o;t.setState({totalProgress:l,files:s})}),this.emitter.on("upload-success",function(e,i){var s=_extends({},t.getState().files),r=_extends({},s[e],{progress:_extends({},s[e].progress,{uploadComplete:!0}),uploadURL:i});s[e]=r,t.setState({files:s})}),this.emitter.on("core:update-meta",function(e,i){t.updateMeta(e,i)})},t.prototype.use=function(t,e){var i=new t(this,e),s=i.id;if(this.plugins[i.type]=this.plugins[i.type]||[],!s)throw new Error("Your plugin must have a name");if(!i.type)throw new Error("Your plugin must have a type");var r=this.getPlugin(s);if(r){var a="Already found a plugin named '"+r.name+"'.\n        Tried to use: '"+s+"'.\n        Uppy is currently limited to running one of every plugin.\n        Share your use case with us over at\n        https://github.com/transloadit/uppy/issues/\n        if you want us to reconsider.";throw new Error(a)}return this.plugins[i.type].push(i),this},t.prototype.getPlugin=function(t){var e=!1;return this.iteratePlugins(function(i){var s=i.id;if(s===t)return e=i,!1}),e},t.prototype.iteratePlugins=function(t){var e=this;Object.keys(this.plugins).forEach(function(i){e.plugins[i].forEach(t)})},t.prototype.log=function(t){this.opts.debug&&(t===""+t?console.log("LOG: "+t):console.dir(t),global.uppyLog=global.uppyLog+"\nDEBUG LOG: "+t)},t.prototype.installAll=function(){var t=this;Object.keys(this.plugins).forEach(function(e){t.plugins[e].forEach(function(t){t.install()})})},t.prototype.run=function(){this.log("Core is run, initializing actions, installing plugins..."),this.actions(),this.plugins.acquirer&&this.plugins.acquirer.length>1&&(this.opts.autoProceed=!1),this.installAll()},t.prototype.initSocket=function(t){return this.socket||(this.socket=new _UppySocket2.default(t)),this.socket},t}();exports.default=Core;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _taggedTemplateLiteralLoose(e,t){return e.raw=t,e}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(['\n    <ul class="UppyGoogleDrive-breadcrumbs">\n      ',"\n    </ul>\n  "],['\n    <ul class="UppyGoogleDrive-breadcrumbs">\n      ',"\n    </ul>\n  "]),_html=require("../../core/html"),_html2=_interopRequireDefault(_html),_Breadcrumb=require("./Breadcrumb"),_Breadcrumb2=_interopRequireDefault(_Breadcrumb);exports.default=function(e){return console.log(e.directories),(0,_html2.default)(_templateObject,e.directories.map(function(t){return(0,_Breadcrumb2.default)({getNextFolder:function(){return e.getNextFolder(t.id,t.title)},title:t.title})}))};
},{"../../core/html":34,"./Breadcrumb":48}],50:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _taggedTemplateLiteralLoose(e,l){return e.raw=l,e}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(['\n    <div>\n      <div class="UppyGoogleDrive-header">\n        <ul class="UppyGoogleDrive-breadcrumbs">\n          ','\n        </ul>\n      </div>\n      <div class="container-fluid">\n        <div class="row">\n          <div class="hidden-md-down col-lg-3 col-xl-3">\n            ','\n          </div>\n          <div class="col-md-12 col-lg-9 col-xl-6">\n            <div class="UppyGoogleDrive-browserContainer">\n              ',"\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  "],['\n    <div>\n      <div class="UppyGoogleDrive-header">\n        <ul class="UppyGoogleDrive-breadcrumbs">\n          ','\n        </ul>\n      </div>\n      <div class="container-fluid">\n        <div class="row">\n          <div class="hidden-md-down col-lg-3 col-xl-3">\n            ','\n          </div>\n          <div class="col-md-12 col-lg-9 col-xl-6">\n            <div class="UppyGoogleDrive-browserContainer">\n              ',"\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  "]),_html=require("../../core/html"),_html2=_interopRequireDefault(_html),_Breadcrumbs=require("./Breadcrumbs"),_Breadcrumbs2=_interopRequireDefault(_Breadcrumbs),_Sidebar=require("./Sidebar"),_Sidebar2=_interopRequireDefault(_Sidebar),_Table=require("./Table"),_Table2=_interopRequireDefault(_Table);exports.default=function(e,l){var r=e.folders,i=e.files;return""!==e.filterInput&&(r=e.filterItems(e.folders),i=e.filterItems(e.files)),(0,_html2.default)(_templateObject,(0,_Breadcrumbs2.default)({getNextFolder:e.getNextFolder,directories:e.directories}),(0,_Sidebar2.default)({getRootDirectory:function(){return e.getNextFolder("root","Google Drive")},logout:e.logout,filterQuery:e.filterQuery,filterInput:e.filterInput}),(0,_Table2.default)({folders:r,files:i,activeRow:e.activeRow,sortByTitle:e.sortByTitle,sortByDate:e.sortByDate,handleRowClick:e.handleRowClick,handleFileDoubleClick:e.addFile,handleFolderDoubleClick:e.getNextFolder}))};
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _taggedTemplateLiteralLoose(e,t){return e.raw=t,e}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}exports.__esModule=!0;var _extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e},_templateObject=_taggedTemplateLiteralLoose(['<div class="UppyProgressBar">\n      <div class="UppyProgressBar-inner" style="width: ','%"></div>\n      <div class="UppyProgressBar-percentage">',"</div>\n    </div>"],['<div class="UppyProgressBar">\n      <div class="UppyProgressBar-inner" style="width: ','%"></div>\n      <div class="UppyProgressBar-percentage">',"</div>\n    </div>"]),_Plugin2=require("./Plugin"),_Plugin3=_interopRequireDefault(_Plugin2),_html=require("../core/html"),_html2=_interopRequireDefault(_html),ProgressBar=function(e){function t(r,n){_classCallCheck(this,t);var o=_possibleConstructorReturn(this,e.call(this,r,n));o.id="ProgressBar",o.title="Progress Bar",o.type="progressindicator";var s={replaceTargetContent:!1};return o.opts=_extends({},s,n),o.render=o.render.bind(o),o}return _inherits(t,e),t.prototype.render=function(e){var t=e.totalProgress||0;return(0,_html2.default)(_templateObject,t,t)},t.prototype.install=function(){var e=this.opts.target,t=this;this.target=this.mount(e,t)},t}(_Plugin3.default);exports.default=ProgressBar;
